...
exports.loadSelectorsConfig = loadSelectorsConfig;
 ...
 */
function loadSelectorsConfig(selectorsPath) {
...
function getCredentials() {
    ...
    if (authMethod !== 'none') {
        if (!credentials.identifier) {
            throw new Error('LOGIN_IDENTIFIER must be set in .env file\n' +
 ...
 */
function getAuthMethod(config) {
    return process.env.AUTH_METHOD || config.authentication.method;
}
